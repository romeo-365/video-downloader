...
def get_links():
    ...
    try:
        ...
        if platform == 'tiktok':
            ...
            # Querying TikWM with full headers to force HD stream detection
            ...
            try:
                with urllib.request.urlopen(req, timeout=10) as response:
                    ...
                    if hd_link:
                        ...
                        # If server doesn't have hdplay, grab play but append high-bitrate query or check size indicator
                        std_link = v_data.get('play')
                        if std_link:
                            formats_list.append({'label': 'Download Standard Quality (9.7MB)', 'url': std_link})
